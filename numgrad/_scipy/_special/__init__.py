...
_bind_vjp(sp.expit, lambda x: lambda g, r: g * r * (1 - r))
_bind_vjp(sp.log_expit, lambda x: lambda g, r: g * (1 - np.exp(r)))

# https://docs.scipy.org/doc/scipy/reference/special.html#gamma-and-related-functions
_bind_vjp(sp.gamma, lambda x: lambda g, r: g * r * sp.digamma(x))
