...
if __name__ == '__main__':
    ...
    w1 = gd.Variable(np.random.normal(scale=0.01, size=(28 * 28 * 1, 100)))
    b1 = gd.Variable(np.random.normal(scale=0.01, size=100))
    w2 = gd.Variable(np.random.normal(scale=0.1, size=(100, 10)))
    b2 = gd.Variable(np.random.normal(scale=0.1, size=10))
