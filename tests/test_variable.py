...
@pytest.mark.parametrize('function, expect', [
    ...
    (lambda: ng.Variable([1, 0]) == 1, np.array([True, False])),
    (lambda: ng.Variable([1, 0]) != 1, np.array([False, True])),
    (lambda: ng.Variable([1, 0]) >= 1, np.array([True, False])),
    (lambda: ng.Variable([2, 0]) > 1, np.array([True, False])),
    (lambda: ng.Variable([1, 0]) <= 1, np.array([True, True])),
    (lambda: ng.Variable([2, 0]) < 1, np.array([False, True])),
